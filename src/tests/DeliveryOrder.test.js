...
describe('DeliveryOrder', () => {
    ...
    it('to check if hidden rows are not present in mobile view', async () => {
        ...
        const { getByLabelText, getByText, queryByTestId, queryAllByText, getAllByTestId, getByTestId } = render(<DeliveryOrder />);
    ...
    it('dropdown item is visible after row click', async () => {
        ...
        const { getByLabelText, getByText, queryByText, queryAllByText, getAllByTestId, getByTestId } = render(<DeliveryOrder />);
